...
int exec()
{
    ...
    static const void *jtInsOp0[] = {&&L0x0, &&L0x1, &&L0x2, &&L0x3, &&L0x4, &&L0x5, &&L0x6, &&L0x7,
                                     &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&DEFAULT, &&L0xf};

    if (insOpCode < 0 || insOpCode > 0xf)
        goto OPDEFAULT;
    goto *jtInsOpCode[insOpCode];
